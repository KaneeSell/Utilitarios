...
const menuLateral = `flex-col h-screen min-w-45 fixed z-2 flex 
...
{/* Menu Lateral */}
    ...
    function MenuLateral(titulo:string){
        return (
            <div id='menuLateral'
            style={{'left':'-100%'}}
            className={menuLateral}>
                <div className='flex flex-col gap-1 pt-2'>
                    ...
                    border-b-1 pb-2
                    `}>
                        <MdMenuOpen size={'30px'} className={`
                        active:bg-black/25 rounded-2xl ms-2
